...
@extends('layout.main')
@section('main')
    <div class="container my-4 w-70porc-mobile margin-0-mobile">
        <div class="contenedor100 azulOscuro align-items-center">
                ...
                @foreach($receta->recetaItem as $i => $recetaIte)
                  ...
                  btn-block btn-danger my-1" data-toggle="modal"
                        ...
                        <form action="{{route('recetasItems.agregar')}}" method="post"  class="d-none-mobile mobile-mleft-14px d-flex flex-row" enctype="multipart/form-data">
                            ...
                            <div class="form-group m-2">
                                <label for="unidad_id_add" class="visually-hidden"></label>
...
// ingrediente nuevo
                ...
                ingSelectAdd.forEach(elem => (
                    elem.addEventListener('change', function () {
                        ...
                        const id = this.dataset.id;
                        const unidadInput = document.getElementById('unidad_id_add');
