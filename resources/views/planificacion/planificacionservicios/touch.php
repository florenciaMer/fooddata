...
<div class="container">
    ...
    <form action="{{ route('planificacion.agregarCabecera') }}"
        ...
        <div class="card w-50 mobile-w-100 my-3 mobile-padding-0">
            ...
            <div class="card-body">
                <div class="d-flex flex-row mobile-padding-0">
                    <input type="text" id="lbl" value="Fecha" placeholder="Seleccioná la fecha" disabled class="form-control">
                    <input type="date" id="fecha{{$i}}"  required name="fecha" class="text-center form-control fw-bold bg-light @error('fecha') is-invalid @enderror"
        ...
        <div class="container m-auto d-flex flex-column">
            ...
            <div class="d-flex flex-row marginTopMenos19 flex-column-mobile mobile-width-100porc">
                <form action="{{route('planificacionItem.agregarItem')}}"
                    ...
                    <div class="d-flex col-row mobile-width-100porc">
                        <select id="tipo_id{{$i}}" name="tipo_id"
    ...
    window.addEventListener('DOMContentLoaded', function() {
        ...
        ingSelect.forEach(elem => (
            elem.addEventListener('click', function () {
                ...
                xhr.open('GET', '/combos/generar_combo_recetas.php?i=' + this.value);
...
//habilitar la receta cuando clickea en cantidad add
    ...
    //
    //                 const ingSelect1 = document.querySelectorAll('.select-tipo');
    //             ingSelect1.forEach(elem => (
    //                 elem.addEventListener('ontouchstart', function () {
    //
    //                     const id = this.dataset.id;
    //                     const selectRecetaInput1 = document.getElementById('receta_id'+ id);
    //                     selectRecetaInput1.disabled = false;
    //                     const xhr = new XMLHttpRequest();
    //                     xhr.open('GET', '/combos/generar_combo_recetas.php?i=' + this.value);
    //                     xhr.addEventListener('readystatechange', function () {
    //
    ...
    //                             if(xhr.status === 200) {
    //                                 // Ahora puedo usar el contenido de la respuesta.
    //                                 selectRecetaInput1.innerHTML = xhr.responseText;
    //                             }
    //                         }
    //                     });
    //                     xhr.send(null);
    ...
    //             )
    //
    //             const ingSelectAdd1 = document.querySelectorAll('.select-tipo-add');
    //             ingSelectAdd.forEach(elem => (
    //                 elem.addEventListener('ontouchstart', function () {
    //                     // Instanciamos el objeto XHR.
    //                     const id = this.dataset.id;
    //                     const selectRecetaInput1 = document.getElementById('receta_id_add');
    //                     selectRecetaInput1.disabled = false;
    //                     const xhr = new XMLHttpRequest();
    //                     xhr.open('GET', '/combos/generar_combo_recetas.php?i=' + this.value);
    //                     xhr.addEventListener('readystatechange', function () {
    ...
    //             )
    // //habilitar la receta cuando clickea en cantidad add
    //             const inputCantAdd1 = document.querySelectorAll('.inputCantAdd');
    //             inputCantAdd1.forEach(elem => (
    //                 elem.addEventListener('ontouchstart', function () {
    //                     // Instanciamos el objeto XHR.
    //                     const id = this.dataset.id;
    //                     const selectRecetaInput = document.getElementById('receta_id_add');
