...
/** @var \Illuminatope\Database\Eloquent\Collection|\App\Models\Unidad[] $unidades */
...
o    <div class="container my-4">
                    ...
                    <div class="card-body">
                        <div class="total">
                            <div class="d-flex flex-row">
                                ...
                                <input id="total1" name="total1"  class="text-center" disabled type="text" value="${{$total/$receta->base}}.-">
                            </div>
                        </div>
                    </div>
        </div>
    ...
    @if($receta->recetaItem()->count() == 0)
        ...
        <div class="form-group mx-1 mt-3 d-flex bg-light">
            ...
            {{--        <span class="marginl12 fs-6 p-2 align-items-md-start text-md-start text-black-50 font-size-19">Costo</span>--}}
            {{--        <span class="marginl12 fs-6 p-2 align-items-md-start text-md-start text-black-50 font-size-19">Costo total</span>--}}
        ...
        <form action="{{route('recetasItems.agregar')}}" method="post"  class="d-flex flex-row m-auto " enctype="multipart/form-data">
            ...
            <div class="form-group m-2">
                <label for="unidad_id_add" class="visually-hidden">Unidad problema</label>
        ...
        <div class="card-body">
            <div class="total">
                <div class="d-flex flex-row">
                    ...
                    <div class="visually-hidden">{{$total_add}} </div>
                    <input id="total1" name="total1"  class="text-center bg-dark text-light" disabled type="text" value="${{$total/$receta->base}}.-">
                </div>
            </div>
        </div>
        @endif
            ...
            window.addEventListener('DOMContentLoaded', function() {
                ...
                ingSelect.forEach(elem => (
                    elem.addEventListener('change', function () {
                        ...
                        xhr.open('GET', '/combo/generar_combo_unidades.php?i=' + this.value);
                ...
                ingSelect2.forEach(elem => (
                    elem.addEventListener('change', function () {
                        ...
                        const xhr = new XMLHttpRequest();
                         xhr.open('GET', '/combo/generar_combo_precios.php?ip=' + this.value);
                        xhr.addEventListener('readystatechange', function () {
...
// ingrediente nuevo
                ...
                // unidad_id_add  cant_add precio_add precioTot_add
                ...
                inputCantAdd.forEach(elem => (
                    elem.addEventListener('change', function () {
                        ...
                        console.log(tot)
                        // parseInt(document.getElementById('cant_add'+id).value);
                ...
                inputCantFirst.forEach(elem => (
                    elem.addEventListener('change', function () {
                        ...
                        console.log('precio input = ' + precioInputFirst)
                ...
                // **********************************************
                const ingSelectAddMas = document.querySelectorAll('.selectIngrediente_id_add');
                ingSelectAddMas.forEach(elem => (
                        elem.addEventListener('change', function () {
                            // Instanciamos el objeto XHR.
                            const id = this.dataset.id;
                            const unidadInputAdd = document.getElementById('unidad_id_add_id_add');
                            const xhr = new XMLHttpRequest();
                            ...
                            xhr.addEventListener('readystatechange', function () {
                                ...
                                if (xhr.readyState === 4) {
                                    if (xhr.status === 200) {
                                        unidadInputAdd.value = xhr.responseText;
                                    }
                                }
                            });
                            xhr.send(null);
